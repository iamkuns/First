      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <table class="table table-bordered" style="color:black;background-color:rgb(255,255,255);border-radius:15px;border-style:none;">
           ...
           <td><%=rs.getString(7) %></td>
                    	...
                    	<td><a href="Slots.jsp?id=<%=rs.getInt(1)%>&slotname=<%=rs.getString(2) %>&address=<%=rs.getString(3) %>&area=<%=rs.getString(4) %>&city=<%=rs.getString(5) %>&state=<%=rs.getString(6) %>"><b>Book</b></a></td>
                    	 </TR>
