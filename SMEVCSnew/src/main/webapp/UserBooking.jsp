      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <table class="table table-bordered" style="color:black;background-color:rgb(255,255,255);border-radius:15px;border:none;">
          ...
          <td><%=rs.getString(8) %></td>
           <td><%=rs.getString(9) %></td>         	
            <td><%=rs.getString(10) %></td>   
              <td><a href="CancelController?id=<%=rs.getInt(1)%>"><b>Cancel</b></a></td> 
                    	 </TR>
