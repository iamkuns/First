 ...
 * Generated at: 2024-06-17 06:35:09 UTC
...
public final class UserRegister_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("            <form action=\"UserRegistrationController\" method=\"post\" id=\"form1\" role=\"form\" class=\"email-form\">\r\n");
      out.write("             \r\n");
      out.write("              <div class=\"form-group mt-3\">\r\n");
      out.write("                <input type=\"text\" class=\"form-control\" name=\"name\" id=\"subject\" placeholder=\"Name\" >\r\n");
      out.write("              </div>\r\n");
      out.write("               <div class=\"form-group mt-3\">\r\n");
      out.write("                <input type=\"text\" class=\"form-control\" name=\"address\" id=\"subject\" placeholder=\"Address\" required>\r\n");
      out.write("              </div>\r\n");
      out.write("               <div class=\"form-group mt-3\">\r\n");
      out.write("                <input type=\"text\" class=\"form-control\" name=\"mobile_no\" id=\"subject\" placeholder=\"Mobile No\" pattern=\"[7-9]{1}[0-9]{9}\" title=\"Mobile number must be starts with 7, 8 or 9 digit and total number of digits are 10\" required=\"required\">\r\n");
      out.write("              </div>\r\n");
      out.write("              <div class=\"form-group mt-3\">\r\n");
      out.write("                <input type=\"email\" class=\"form-control\" name=\"email\" id=\"subject\" placeholder=\"Email\" pattern=\"[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,3}$\" title=\"Email-Id must be valid format.\" required=\"required\">\r\n");
      out.write("              </div>\r\n");
      out.write("               <div class=\"form-group mt-3\">\r\n");
      out.write("                <input type=\"password\" class=\"form-control\" name=\"password\" id=\"myInput\" placeholder=\"Password\" pattern=\"(?=^.{8,}$)((?=.*\\d)|(?=.*\\W+))(?![.\\n])(?=.*[A-Z])(?=.*[a-z]).*$\" title=\"Password must contain at least one number and one special character and one uppercase and lowercase letter, and at least 8 or more characters\" required=\"required\">\r\n");
      out.write("              <input type=\"checkbox\" onclick=\"myFunction()\">Show Password\r\n");
      out.write("              </div>\r\n");
      out.write("              <div class=\"form-group mt-3\">\r\n");
      out.write("                <input type=\"password\" class=\"form-control\" name=\"conf_password\" id=\"subject\" placeholder=\"Confirm Password\" pattern=\"(?=^.{8,}$)((?=.*\\d)|(?=.*\\W+))(?![.\\n])(?=.*[A-Z])(?=.*[a-z]).*$\" title=\"Password must contain at least one number and one special character and one uppercase and lowercase letter, and at least 8 or more characters\" required=\"required\">\r\n");
      out.write("              </div>\r\n");
      out.write("               <div class=\"form-group mt-3\">\r\n");
      out.write("                <input type=\"text\" class=\"form-control\" name=\"vehicle_no\" id=\"subject\" placeholder=\"Vehicle No\" required>\r\n");
      out.write("              </div>\r\n");
      out.write("               <div class=\"form-group mt-3\">\r\n");
      out.write("                <input type=\"text\" class=\"form-control\" name=\"vehicle_name\" id=\"subject\" placeholder=\"Vehicle Name\" required>\r\n");
      out.write("              </div>\r\n");
      out.write("              <div class=\"form-group mt-3\">\r\n");
      out.write("                <input type=\"text\" class=\"form-control\" name=\"vehicle_owner_name\" id=\"subject\" placeholder=\"Vehicle Owner Name\" pattern=\"[A-Za-z]+\" title=\"Name must be alphabets only\" required=\"required\">\r\n");
      out.write("              </div>\r\n");
      out.write("             <br><br>\r\n");
      out.write("             \r\n");
      out.write("              <div class=\"text-center\"> <button type=\"submit\" form=\"form1\" value=\"Submit\">Register</button>&nbsp;&nbsp;&nbsp;<br><br>if you have already registered<br> <a href=\"UserLogin.jsp\">click here?</a></div>\r\n");
      out.write("              \r\n");
      out.write("            </form>\r\n");
      out.write("\r\n");
      out.write("          </div>\r\n");
