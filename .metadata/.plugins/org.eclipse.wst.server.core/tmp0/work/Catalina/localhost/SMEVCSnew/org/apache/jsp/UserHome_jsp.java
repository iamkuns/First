 ...
 * Generated at: 2024-10-05 05:58:42 UTC
...
public final class UserHome_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("          <button id=\"connect-button\" class=\"btn btn-primary\">Connect Bluetooth</button>\r\n");
  ...
  System.out.println("Welcome user:"+name);
      ...
      out.write("  \r\n");
      out.write("<!-- Web Bluetooth Script -->\r\n");
      out.write("  <script>\r\n");
      out.write("    const serviceUUID = \"4fafc201-1fb5-459e-8fcc-c5c9c331914b\";\r\n");
      out.write("    const characteristicUUID = \"beb5483e-36e1-4688-b7f5-ea07361b26a8\";\r\n");
      out.write("\r\n");
      out.write("    async function connectToDevice() {\r\n");
      out.write("      try {\r\n");
      out.write("        // Request the BLE device\r\n");
      out.write("        const device = await navigator.bluetooth.requestDevice({\r\n");
      out.write("          filters: [{ services: [serviceUUID] }]\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // Connect to the GATT server\r\n");
      out.write("        const server = await device.gatt.connect();\r\n");
      out.write("\r\n");
      out.write("        // Get the service and characteristic\r\n");
      out.write("        const service = await server.getPrimaryService(serviceUUID);\r\n");
      out.write("        const characteristic = await service.getCharacteristic(characteristicUUID);\r\n");
      out.write("\r\n");
      out.write("        // Subscribe to characteristic notifications\r\n");
      out.write("        characteristic.startNotifications();\r\n");
      out.write("        characteristic.addEventListener('characteristicvaluechanged', handleCharacteristicValueChanged);\r\n");
      out.write("\r\n");
      out.write("        console.log('Connected to ESP32 BLE device');\r\n");
      out.write("      } catch (error) {\r\n");
      out.write("        console.error('Error connecting to BLE device:', error);\r\n");
      out.write("      }\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // Handle the characteristic value changed event\r\n");
      out.write("    function handleCharacteristicValueChanged(event) {\r\n");
      out.write("      const value = new TextDecoder().decode(event.target.value);\r\n");
      out.write("      const data = JSON.parse(value);\r\n");
      out.write("\r\n");
      out.write("      // Update the battery level and temperature in the DOM\r\n");
      out.write("      document.getElementById('battery-level').textContent = `Battery Level: ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${data.batteryLevel}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("%`;\r\n");
      out.write("      document.getElementById('battery-temperature').textContent = `Battery Temperature: ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${data.temperature}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("°C`;\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // Set up the connect button click event\r\n");
      out.write("    document.getElementById('connect-button').addEventListener('click', connectToDevice);\r\n");
      out.write("  </script>\r\n");
      out.write("</body>\r\n");
      out.write("\r\n");
      out.write("</html>");
