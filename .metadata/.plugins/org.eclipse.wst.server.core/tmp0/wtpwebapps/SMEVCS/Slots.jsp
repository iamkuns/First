...
%>
        <div class="row">
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <form action="SearchSlotcontroller" method="post" role="form">
             
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="slotname" value=<%=slotname%> required>
              </div>
             ...
             <br><br>
              ...
              <div class="text-center"><button type="submit">Book</button>&nbsp;&nbsp;&nbsp;<br><br>
              </div>
            </form>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Charge it 2023</span></strong>. All Rights Reserved
      </div>
